package com.oauth.system.oauthapisystem.email.oauth;
...
public class OAuthClientService {
    ...
    // ✅ API 요청 메서드
    public  <T> T callApiWithToken(String apiEndpoint, HttpMethod httpMethod, Object data, Class<T> responseType) {
